...
@php
    $milestones = content_items('home_our_story_milestones');
@endphp
...
<section class="page-section cl-story-section" id="our-story">
    <div class="container">
        <div class="cl-story-head">
            <div>
                <p class="section-eyebrow mb-2" data-reveal>{{ content('home_our_story', 'paragraph') }}</p>
                <h2 class="cl-story-title" data-reveal>
                    {{ content('home_our_story', 'heading') }}<br><span>{{ content('home_our_story', 'label') }}</span>
                </h2>
            </div>
        </div>
        ...
        <div class="cl-story-stats" data-reveal>
            @foreach (content_items('home_our_story_story_stats') as $contentRow)
<div><strong>{{ $contentRow['label'] }}</strong><span>{{ $contentRow['label_2'] }}</span></div>
@endforeach
        </div>
    </div>
</section>
