...
return new class extends Migration
{
    ...
    {
        Schema::create('cms_home_tech_diagram', function (Blueprint $table) {
            $table->id();
            $table->string('seed_key')->unique('cms_36a1ee8b9d3d_seed');
            $table->unsignedInteger('sort_order')->default(0)->index('cms_36a1ee8b9d3d_order');
    ...
    {
        Schema::dropIfExists('cms_home_tech_diagram');
    }
};
