...
return new class extends Migration
{
    ...
    {
        Schema::create('cms_page_capacity_building', function (Blueprint $table) {
            $table->id();
            $table->string('seed_key')->unique('cms_9dd118dfa278_seed');
            $table->unsignedInteger('sort_order')->default(0)->index('cms_9dd118dfa278_order');
    ...
    {
        Schema::dropIfExists('cms_page_capacity_building');
    }
};
