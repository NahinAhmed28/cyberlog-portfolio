...
return new class extends Migration
{
    ...
    {
        Schema::create('cms_page_it_audit', function (Blueprint $table) {
            $table->id();
            $table->string('seed_key')->unique('cms_3bb7ebc5cb2b_seed');
            $table->unsignedInteger('sort_order')->default(0)->index('cms_3bb7ebc5cb2b_order');
    ...
    {
        Schema::dropIfExists('cms_page_it_audit');
    }
};
