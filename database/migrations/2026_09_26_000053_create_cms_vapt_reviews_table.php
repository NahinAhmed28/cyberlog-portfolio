...
return new class extends Migration
{
    ...
    {
        Schema::create('cms_vapt_reviews', function (Blueprint $table) {
            $table->id();
            $table->string('seed_key')->unique('cms_6e300adca87c_seed');
            $table->unsignedInteger('sort_order')->default(0)->index('cms_6e300adca87c_order');
    ...
    {
        Schema::dropIfExists('cms_vapt_reviews');
    }
};
