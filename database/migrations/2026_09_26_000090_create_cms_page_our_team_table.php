...
return new class extends Migration
{
    ...
    {
        Schema::create('cms_page_our_team', function (Blueprint $table) {
            $table->id();
            $table->string('seed_key')->unique('cms_2932bfd3602a_seed');
            $table->unsignedInteger('sort_order')->default(0)->index('cms_2932bfd3602a_order');
    ...
    {
        Schema::dropIfExists('cms_page_our_team');
    }
};
