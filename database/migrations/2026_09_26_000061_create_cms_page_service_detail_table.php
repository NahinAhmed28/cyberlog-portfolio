...
return new class extends Migration
{
    ...
    {
        Schema::create('cms_page_service_detail', function (Blueprint $table) {
            $table->id();
            $table->string('seed_key')->unique('cms_004175add17c_seed');
            $table->unsignedInteger('sort_order')->default(0)->index('cms_004175add17c_order');
    ...
    {
        Schema::dropIfExists('cms_page_service_detail');
    }
};
