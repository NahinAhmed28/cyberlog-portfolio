...
return new class extends Migration
{
    ...
    {
        Schema::create('cms_soc_reviews', function (Blueprint $table) {
            $table->id();
            $table->string('seed_key')->unique('cms_274d94be02a1_seed');
            $table->unsignedInteger('sort_order')->default(0)->index('cms_274d94be02a1_order');
    ...
    {
        Schema::dropIfExists('cms_soc_reviews');
    }
};
