...
return new class extends Migration
{
    ...
    {
        Schema::create('cms_shared_reviews', function (Blueprint $table) {
            $table->id();
            $table->string('seed_key')->unique('cms_40358ac493ba_seed');
            $table->unsignedInteger('sort_order')->default(0)->index('cms_40358ac493ba_order');
    ...
    {
        Schema::dropIfExists('cms_shared_reviews');
    }
};
